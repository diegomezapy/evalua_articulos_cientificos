// app.js - Evaluador de Calidad de Artículos Científicos
...
class ScientificArticleAnalyzer {
        ...
        this.results.forEach((result, index) => {
            ...
            const row = `
                <tr>
                    <td>${result.filename}</td>
                    <td>
                        <span class="badge ${this.getScoreBadgeClass(result.globalScore)}">
                            ${result.globalScore}
                        </span>
                    </td>
                    <td>
    ...
    calculateDimensionScore(dimension) {
        ...
        return `<span class="badge ${this.getScoreBadgeClass(score)}">${score}</span>`;
    }
